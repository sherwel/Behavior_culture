...
#         temp.append('classid')
        ...
        studentattenddata.append((studentid,temp[11]))
    ...
    if result:
        result=sqlhelp.inserttableinfo_byparams(config.Config.student_attend_table, ['studentId','classId'], studentattenddata)
        if result:
