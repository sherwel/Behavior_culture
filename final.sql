...
--
-- Host: localhost    Database: t_qcpj
-- ------------------------------------------------------
...
INSERT INTO `t_class_name` VALUES ('2A413598','二班',2),('2A413598-F3DB-40B3-BD46-FEB9395BDE51','一班',1);
...
INSERT INTO `t_classes` VALUES (10,1,'21'),(10,2,'2A413598'),(10,1,'2A413598-F3DB-40B3-BD46-FEB9395BDE51'),(10,1,'31'),(10,1,'51'),(10,2,'w');
...
INSERT INTO `t_coin` VALUES (0,1,'分数'),(1,0,'科学素养'),(2,0,'人文素养'),(3,0,'德育素养'),(4,0,'实践素养'),(5,0,'艺术素养');
...
INSERT INTO `t_content_evaluation` VALUES ('1','你卤味测试',0,'1');
...
CREATE TABLE `t_family_evaluation` (
  ...
  PRIMARY KEY (`studentId`,`time`,`contentEvaluationId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_family_evaluation` VALUES ('100001','1',10,'0000-00-00 00:00:00','1','0','');
...
INSERT INTO `t_school` VALUES (1,'广东','珠海','珠海香洲第一小学','0000-00-00 00:00:00'),(2,'广东','雷州','北京师范大学附属小学','0000-00-00 00:00:00'),(3,'广东','珠海','中山大学','0000-00-00 00:00:00'),(5,'广西','桂林','桂林大学','0000-00-00 00:00:00'),(10,'广东','珠海','北京师范大学珠海分校','0000-00-00 00:00:00');
...
CREATE TABLE `t_student` (
  ...
  `placeOfOrigin` varchar(100) NOT NULL,
...
CREATE TABLE `t_student_evaluation` (
  ...
  `time` varchar(24) NOT NULL,
  `week` varchar(10) NOT NULL,
  PRIMARY KEY (`studentId`,`evaluationObject`,`time`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_teach` (
  ...
  PRIMARY KEY (`techerId`,`classId`,`masterId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_teach` VALUES ('1','2A413598',0),('1','2A413598-F3DB-40B3-BD46-FEB9395BDE51',1),('2','2A413598-F3DB-40B3-BD46-FEB9395BDE5',0),('3','2A413598-F3DB-40B3-BD46-FEB9395BDE',0);
...
-- Dump completed on 2016-01-31 16:23:51
